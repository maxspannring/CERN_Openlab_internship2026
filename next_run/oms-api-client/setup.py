...
if sys.version_info.major == 2:
    ...
    if sys.version_info.major == 3 and sys.version_info.minor >= 11:
        #ALMA9/RHEL9+
        python_version = python_version_dep = 'python'+str(sys.version_info.major)+ "." + str(sys.version_info.minor) + '-'
        RPM_REQUIRED_DEPS = python_version_dep + 'requests,' + python_version_dep[:-1]
    else:
        python_version = python_version_dep = 'python' + str(sys.version_info.major) + str(sys.version_info.minor) + '-'
        RPM_REQUIRED_DEPS = python_version_dep + 'requests'
